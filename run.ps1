...
for ($seed = $seed_from; $seed -le $seed_to; $seed++) {
    ...
    $command = "C:\Users\Mic\source\repos\protein_folding\x64\Release\protein_folding.exe $sequence -seed $seed -target $target -nfesLmt $nfesLmt -runtimeLmt $runtimeLmt -Np $Np"
